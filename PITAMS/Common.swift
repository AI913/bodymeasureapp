...
struct CV {
    ...
    public static func initUrl() {
        ...
        case 1:
            ...
            CV.loginUrl = "http://192.168.11.122:5000/login"
            CV.empUrl = "http://192.168.11.122:5000/empinfo"
            CV.uploadUrl = "http://192.168.11.122:5000/upload"
            CV.poricyUrl = "http://18.182.182.6/static/privacy-policy.html"
        case 2:
    ...
    public static var nowType:Int = -1
    ...
    public static var GyroFlg:Bool = true

    //画像確定サイズ
    public static let imgSizeX:Int = 1440
    public static let imgSizeY:Int = 2560
    //サイズ保存用
    ...
    //閾値値
    public static var threshold:Int = 220
    //二値化オン/オフ
...
struct RESDATA{
    ...
    public static var lodinReq:LoginReq?
    public static var loginRes:LoginData?
    public static var empRes:EmpData?
    public static var uploadRes:UploadData?
    public static var measurements:Measurements?
    public static var shoulder:CGFloat?
    public static var chest:CGFloat?
    public static var body:CGFloat?
    public static var waist:CGFloat?
}
...
struct Measurements: Codable {
    var shoulder, chest, body, waist: CGFloat
}
//社員情報リクエスト
...
struct MSG {
    ...
    public static let ERR_DAT_NIL:String = "データを入力していない状態です。"
    public static let ERR_REP:String = "新しい線を描く前、まず描いた線を消してください。"
    public static let ERR_LINE_NIL:String = "線を描いてください。"
    //共通エラーメッセージ
...
class Util {
    ...
    static var connectionFlg = false
